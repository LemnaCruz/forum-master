...
final class DeleteQuestionController extends AbstractController implements AuthenticatedControllerInterface
{
 ...
 *     tags={"Questions"},
 *     summary="Delets the question with the provided question identifier",
